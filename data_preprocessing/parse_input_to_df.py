...
def get_seq_by_geneid(gb_file, gene_id, up_region, down_region):
    ...
    for record in records:
        ...
        for feature in record.features:
            if feature.type == "gene" and (gene_id in feature.qualifiers.get("locus_tag", []) )  or ( gene_id in  feature.qualifiers.get("gene", []) ) :
                #取序列
...
def blast_search(input_file_path,genome,workdir):
    ...
    with open(input_file_path,'r') as ifile:
        index = 0 
        for line in ifile:
            if 'CR382129.1_199_insertion' in line:
                print("jkjsadjklsdjkl")
    ...
    print(cmd1)
    os.system(cmd1)
    cmd2 = "blastn -query "+input_fasta+" -db "+ref_lib+" -outfmt 6 -task blastn -out "+blast_output_file_path+" -evalue 1e-100"
    os.system(cmd2)
...
def execute_input_2_chopchop_input(input_file_path,  genome_path, convert_input_file_chopchopInput_workdir, chopchop_input, scene, gb_file=''):
    ...
    # before_info_input_df = before_info_input_df[before_info_input_df["Name"]=="b0068_del"] 
    ...
    if scene == 'only_primer':
        print("原始",before_info_input_df.columns)
        before_info_input_df = before_info_input_df.rename(columns={"guide sequence (n20)":"crrna"})  
        print("重命名",before_info_input_df.columns)
...
if __name__ == '__main__':
    ...
    if  call_method == 1:
        ...
        data3 = {
                    "input_file_path":"/home/yanghe/program/data_preprocessing/temp/designing_only_primers_1.csv",   
                    "ref_genome":"/home/yanghe/program/data_preprocessing/temp/GCA_000011325.1_ASM1132v1_genomic.fna",
                    "data_preprocessing_workdir":"/home/yanghe/tmp/data_preprocessing/output/",
                    "scene":"only_primer",  
                }
        ...
        #大肠全敲
        data7 = {
                    "input_file_path":"/home/yanghe/program/data_preprocessing/temp/eco_all_knock_out.csv",
                    "ref_genome":"/home/yanghe/program/data_preprocessing/temp/eco.gb",
                    "data_preprocessing_workdir":"/home/yanghe/tmp/data_preprocessing/output/", 
                    "scene":"both_sgRNA_primer",
                }
        #大肠rna敲除
        ...
        data9 = {
            "input_file_path":"/home/yanghe/program/data_preprocessing/input/designing_only_primers_2.csv",
        ...
        data10 = {
            "input_file_path":"/home/yanghe/program/data_preprocessing/input/dele_info.csv",
            "ref_genome":"/home/yanghe/program/data_preprocessing/input/GCA_000011325.1_ASM1132v1_genomic.gbff",
            "data_preprocessing_workdir":"/home/yanghe/tmp/data_preprocessing/output/",  
            "scene":"both_sgRNA_primer"
        }  
